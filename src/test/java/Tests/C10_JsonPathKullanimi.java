...
public class C10_JsonPathKullanimi {
    ...
    public void method1(){
        ...
        // iç içe birden fazla json yapısı ve arrayi olan bir json oluşturalım
        ...
        System.out.println("firstName : "
                + kisiBilgileriJsonObj.get("firstName"));

        System.out.println("lastName : "
                + kisiBilgileriJsonObj.get("lastName"));

        System.out.println("cadde : "
                + kisiBilgileriJsonObj
        ...
        // Bu bilgileri burada yazdırmak yerine jsonpath.com kullanarak da ulaşabilirz.
